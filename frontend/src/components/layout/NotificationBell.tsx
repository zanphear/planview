  ...
  const groupByDate = (notifs: typeof notifications) => {
    ...
    for (const n of notifs) {
      ...
      if (dateStr === today) label = 'Today';
        ...
        label = new Date(n.created_at).toLocaleDateString('en-GB', {
          weekday: 'long',
          day: 'numeric',
          month: 'short',
        });
                ...
                groupByDate(notifications).map((group) => (
                  <div key={group.label}>
                    ...
                    {group.items.map((notif) => (
                      ...
                      >
                        {notif.actor ? (
                          <Avatar name={notif.actor.name} colour={notif.actor.colour} size={36} />
                        ) : (
                          <div
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className={`text-sm leading-snug ${!notif.is_read ? 'font-medium' : ''}`}
